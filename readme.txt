...
Author URI: https://help.libsynsupport.com/hc/en-us/articles/360041220971-Installing-Configuring-the-Libsyn-Publisher-Hub-WordPress-Plugin
...
You may create a support issue on the [LPH Plugin Page](https://wordpress.org/plugins/libsyn-podcasting/).  If you have any questions with the setup process or usage of the plugin, please contact *<support@libsyn.com>*.

= Where do I report security bugs found in this plugin? =
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/libsyn-podcasting)


== Changelog ==

= 1.4.4 =
* Testing up to Wordpress 6.3.1
* Changes to some of the ajax calls
* Updates for plugin security

= 1.4.2 =
* Testing up to Wordpress 6.3
* Fix for WP version number

= 1.4.1 =
* Testing up to Wordpress 6.2.2
* Support for PHP versions up to 8.2.
* Ended support for PHP versions lower than 7.2.
* Fixed issue with incorrectly reporting active status in debug_log.
* Fixed issue with classic editor schedule calendar.

= 1.3.2 =
* Bug fix causing issue with php < 7.2 compatibility.

= 1.3.1 =
* Added show selector from the posts page.
* Added premium episode selection from the posts page.
* Testing up to Wordpress 5.8
* Style changes to align with Libsyn 5 platform.
* Feed importer workflow changes and improvements.
* Upgrades and fixes to Libsyn Block editor.
* Misc. bug fixes and style changes.
