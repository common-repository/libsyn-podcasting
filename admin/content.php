					...
					<tr valign="top">
					  ...
					  <td valign="top">
						<div class="libsyn-help-tip-container" style="position:relative;">
							<?php submit_button(__('Create New Episode', $libsyn_text_dom), 'button-primary libsyn-dashicons-plus-alt button-width-220', 'l0ibsyn_create_post', false, array('id' => 'submit_create_post_top')); ?>
							&nbsp;
							<div class="libsyn-help-tip" style="display:inline;">
								<p style="margin-top: 12px;">Creates a new Wordpress post, including the Libsyn HTML5 Media Player, and creates an episode in Libsyn that releases to your destinations.</p>
							</div>
							<br />
							<br />
						</div>
