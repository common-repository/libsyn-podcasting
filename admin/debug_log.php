	...
	<div id="poststuff">
		<form name="<?php echo LIBSYN_NS . "form" ?>" id="<?php echo LIBSYN_NS . "form" ?>" method="post" action="javascript:void(0);">
			<div id="post-body-content">
					...
					<div class="inside">
							...
							<div style="line-height:2.4em;">
								<div>
									<dl>
										<dt>
											<button type="button" id="libsyn-download-log-button" class="button button-primary libsyn-dashicons-download">Download Log</button>
										</dt>
										<dd>
											<em>If you are having trouble with the plugin please download the log file to submit to our developers.</em>
										</dd>
									</dl>
								</div>
							</div>
							...
							<div style="line-height:2.4em;" id="libsyn-download-phpinfo-div">
								<div>
									<dl>
										<dt>
											<button type="button" id="libsyn-download-phpinfo-button" class="button button-primary button-width-280 libsyn-dashicons-download">Download Php Information</button>
										</dt>
										<dd>
											<em>Optionally, you may also submit your PHP server information running Wordpress.</em>
										</dd>
									</dl>
								</div>
							</div>
				...
				<div class="stuffbox libsyn-meta-box" id="libsyn-phpinfo-box" style="width:93.5%;display:none;">
				...
				if ( libsynPluginLoggerFilePath.length > 0 ) {
					$("#libsyn-download-log-button").click(function(){
						$.ajax({
							...
							type: "GET",
							success: function(e){
								$("#libsyn-download-log-containter").fadeIn('fast');
